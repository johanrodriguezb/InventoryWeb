		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					...
					sencilla para la modificación de Prestamos en el sistema.
				</p>
			</div>
		</section>
		<div class="container">
			...
			<form id="nuevo" name="nuevo" method="POST" action="ejecutar.php?c=Prestamos&a=actualizarP" autocomplete="off">
									...
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="form-group">
												<label for="inicial">Serial del equipo</label>
												<input type="text" class="form-control" id="Activos_idActivo" name="Activos_idActivo" value="<?php echo $data["prestamos"]["Nserial"]; ?>" disabled />
											</div>
